<div align="center">
  ...
  *High-performance, engine-grade security for Roblox backends*
  ...
  [![Version](https://img.shields.io/badge/version-3.2.1-blue?style=flat-square)](https://github.com/Jeremy84100/RateLimiter)
...
```toml
[dependencies]
RateLimiter = "jeremy84100/ratelimiter@3.2.1"
```
